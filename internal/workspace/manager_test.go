...
func TestConcurrentOpenConverges(t *testing.T) {
	...
	manager.loadWorkspace = func(context.Context, string, directoryObserver) (workspaceContent, error) {
		if loads.Add(1) == 1 {
			close(started)
		}
...
func TestFailedOpenIsClassifiedRemovedAndRetryable(t *testing.T) {
	...
	manager.loadWorkspace = func(_ context.Context, canonical string, _ directoryObserver) (workspaceContent, error) {
		manager.mu.RLock()
...
func TestCanceledOwnerDoesNotFailActiveWaiter(t *testing.T) {
	...
	manager.loadWorkspace = func(ctx context.Context, root string, _ directoryObserver) (workspaceContent, error) {
		attemptsMu.Lock()
