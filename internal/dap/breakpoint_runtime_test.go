...
func (d *breakpointDebugger) Start(ctx context.Context) (*apidebugger.Event, error) {
	if d.startFn != nil {
		return d.startFn(ctx)
	}

	return d.Session.Start(ctx)
}
